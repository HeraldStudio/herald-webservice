...
exports.route = {
  ...
  async post() {
    console.log((await axios.get('http://srtp.seu.edu.cn/seu_back/Home/Cas?ticket=ST-1012841-KHiSBlvfbmeG2SNItEAA1606099829587-XiFT-cas')).headers)
    console.log(Object.keys(await axios.get('http://srtp.seu.edu.cn/seu_back/Home/Cas?ticket=ST-1012841-KHiSBlvfbmeG2SNItEAA1606099829587-XiFT-cas')))
  }
}